...
bind_rows(nz_data$`case_data_nz_2001-2012_all_surveillance`,
  ...
  write.csv('../results/processed_data/case_data_nz_all_surveillance.csv')
...
bind_rows(nz_data$`case_data_nz_2001-2012_all_surveillance_untyped_assigned`,
  ...
  write.csv('../results/processed_data/case_data_nz_all_surveillance_untyped_assigned.csv')
...
bind_rows(nz_data$`case_data_nz_2001-2012_sentinel_only_untyped_assigned`,
  ...
  write.csv('../results/processed_data/case_data_nz_sentinel_only_untyped_assigned.csv')
...
bind_rows(nz_data$`case_data_nz_2001-2012_nonsentinel_only_untyped_assigned`,
  ...
  write.csv('../results/processed_data/case_data_nz_nonsentinel_only_untyped_assigned.csv')
