...
selected_model_name = args[8] # Model name (see model_functions.R)
selected_par_names = args[9] # Comma-separated list of selected parameter names selected_par_names <- "Vic_against_Vic_protection,Yam_against_Vic_protection"
lower_limits = args[10] # Comma-separated list of lower bounds for parameter values 
upper_limits = args[11] # Comma-separated list of upper bounds for parameter values 
increments = args[12] # Comma-separated values for the increment between par1 and par2 values
output_directory <- args[13]
n_cores <- as.integer(args[14])
initial_par_bounds_path = as.character(args[15])
bounded_par_names <- as.character(args[16]) # Comma-separated list of pars with non-default bounds
bounded_par_lbounds <- as.character(args[17]) # Comma-separated list of lower non-default bounds 
bounded_par_ubounds <- as.character(args[18]) # Comma-separated list of upper non-default bounds
